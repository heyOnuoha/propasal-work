    ...
    <span id="span" class="ico">  <i class="fas fa-bars" id="menbar"></i> CEG GHANA</span>
      ...
      <div class="center" id="mb">
          <ul>
              ...
              <ul id="ministiedd" style="font-size:13px; display:none;">
                <br>
              ...
              <ul id="bookshopdb" style="display:none;">
      ...
      <div class="right" id="mb">
       <ul>
         ...
         <li style="display:inline-block;"><i class="fas fa-shopping-cart" style="margin-left:10px; font-size:20px;"></i> <b id="shoppincars">0</b> </li>
         <li ></li>
       </ul>
